defmodule GameTest do
  ...
  @moduledoc """
  some of these tests require manually marking cells, in order for this to work you need to disable comp_move_smart in the GameCore module line 109 and just return a game map
  """
